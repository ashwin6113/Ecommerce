...
const Navbar = () => {
  ...
  return (
    <nav className="navbar flex justify-between align-middle bg-base-100 px-10">
      <div className="navbar-start basis-1/4 flex justify-center align-middle">
        <div className="w-40">
          <svg
      ...
      <div className="navbar-center basis-1/2 hidden lg:flex">
        <ul className="menu menu-horizontal px-1">
          {mainHead.map((head, key) => {
            return (
              <li key={key}>
                <Link href={head.link}>{head.head}</Link>
              </li>
            );
          })}
        </ul>
